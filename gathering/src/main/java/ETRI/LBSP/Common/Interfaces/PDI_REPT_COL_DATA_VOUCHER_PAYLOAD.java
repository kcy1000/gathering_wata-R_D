...
public class PDI_REPT_COL_DATA_VOUCHER_PAYLOAD
{
	// v2.11
...
//	public double			FD17_TM_Y;
	...
	public PDI_REPT_COL_DATA_VOUCHER_PAYLOAD()
	{
	...
	public void FD8_ColP_F ( String ColP_F )
	{
		...
		try
		{
			...
			WataLog.e("UnsupportedEncodingException=" + e.toString());
			e.printStackTrace();
		}
	}
...
//			if(FD9_ColMag_X < 99999){
//				buf.putFloat(FD9_ColMag_X);
//			} else {
//				FD9_ColMag_X = 0;
//				FD10_ColMag_Y = 0;
//			}
//
//			if(FD10_ColMag_Y < 99999){
//				buf.putFloat(FD10_ColMag_Y);
//			} else {
//				FD9_ColMag_X = 0;
//				FD10_ColMag_Y = 0;
//			}
...
//		length += 8+8; //TM_X, TM_Y
	...
	public static PDI_REPT_COL_DATA_VOUCHER_PAYLOAD decode (ByteBuffer packet )
	{
		int offset = 0;
		PDI_REPT_COL_DATA_VOUCHER_PAYLOAD z = new PDI_REPT_COL_DATA_VOUCHER_PAYLOAD();
		...
		System.out.println ( "  - PDI_REPT_COL_DATA_VOUCHER_PAYLOAD, decode(), FD1_Payload_SIZE=" + z.FD1_Payload_SIZE );
		offset += 4;
		...
		WataLog.d("tmpBuf)="  +tmpBuf);
		tmpBuf.put ( buf, offset, 2 );
		WataLog.d("tmpBuf.getShort(0)="  +tmpBuf.getShort(0));

		z.FD4_ColP_F_LEN = tmpBuf.getShort(0);
//		z.FD4_ColP_F_LEN = 4;
		System.out.println ( "  - PDI_REPT_COL_DATA_VOUCHER_PAYLOAD, decode(), FD4_ColP_F_LEN=" + z.FD4_ColP_F_LEN );
		offset += 2;

		// FD8_ColP_F
		WataLog.d("z.FD4_ColP_F_LEN="  +z.FD4_ColP_F_LEN);
		tmpBuf = ByteBuffer.allocate(z.FD4_ColP_F_LEN);
		WataLog.d("tmpBuf="  + tmpBuf);
		WataLog.d("buf="  + buf);
		WataLog.d("offset="  + offset);
		...
		WataLog.d("  - PDI_REPT_COL_DATA_VOUCHER_PAYLOAD, decode(), FD5_ColP_F=" + z.FD5_ColP_F );
		System.out.println ( "  - PDI_REPT_COL_DATA_VOUCHER_PAYLOAD, decode(), FD5_ColP_F=" + z.FD5_ColP_F );
		offset += z.FD4_ColP_F_LEN;

		// FD9_ColTime
		byte[] FD9_ColTimeByte = new byte[14];
		System.arraycopy ( buf, offset, FD9_ColTimeByte, 0, 14);
		WataLog.d("zFD9_ColTimeByte=" + FD9_ColTimeByte);
		z.FD6_ColTime = new String(FD9_ColTimeByte);

		System.out.println ( "  - PDI_REPT_COL_DATA_VOUCHER_PAYLOAD, decode(), FD6_ColTime=" + z.FD6_ColTime );
		offset += 14;
		...
		System.out.println ( "  - PDI_REPT_COL_DATA_VOUCHER_PAYLOAD, decode(), FD7_SCANINFO_A_CNT=" + z.FD7_SCANINFO_A_CNT );
		offset += 2;
