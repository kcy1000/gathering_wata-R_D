...
public class PDI_REPT_COL_DATA_VOUCHER_PAYLOAD_NOMAGNET
{
	...
	public PDI_REPT_COL_DATA_VOUCHER_PAYLOAD_NOMAGNET()
	{
...
//		Log.i("PDI_REPT_COL_DATA_PAYLOAD, packet()", "length=" + length);	
	...
	public static PDI_REPT_COL_DATA_VOUCHER_PAYLOAD_NOMAGNET decode (ByteBuffer packet )
	{
		int offset = 0;
		PDI_REPT_COL_DATA_VOUCHER_PAYLOAD_NOMAGNET z = new PDI_REPT_COL_DATA_VOUCHER_PAYLOAD_NOMAGNET();
		...
		WataLog.d("FD4_ColP_F_LEN="  +z.FD4_ColP_F_LEN);
