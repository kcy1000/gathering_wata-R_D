package com.geotwo.LAB_TEST.GPS;
...
import com.geotwo.LAB_TEST.Voucher.VoucherDataCore;
import com.geotwo.LAB_TEST.Voucher.VoucherPoiListAdapter;
import com.geotwo.LAB_TEST.Voucher.VoucherSettingDialog;
import com.geotwo.LAB_TEST.Voucher.VoucherWifiScanner;
...
public class GPSActivity extends AppCompatActivity implements OnClickListener {
    static {
...
//        });
        ...
        if (!_bleManager.isBluetoothEnabled()) {
            geo2.lbsp.ible.Utils.startBluetooth(this, new StartCompletedListener() {
                public void onStartCompleted() {
                    Toast.makeText(GPSActivity.this, "'Bluetooth가 활성화 되었습니다.", Toast.LENGTH_SHORT).show();
                }
            });
        }
    ...
    private void webViewSetting() {
        ...
        mVoucherWebBridge = new GPSActivity.VoucherWebBridge(GPSActivity.this);
        ...
        mWebView.setWebViewClient(new GPSActivity.WebViewClientClass());
...
//        public double endPointY = 0.0;
        ...
        private GPSActivity mVoucherActivity;

        public VoucherWebBridge(GPSActivity voucherActivity) {
...
//        onToast(Gravity.CENTER, String.valueOf(overLine));
    ...
    private void setDeletePOIPopup(final PoiInfo items, final int position) {
        AlertDialog.Builder alBuilder = new AlertDialog.Builder(GPSActivity.this);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.poi_file_upload_btn:
                ...
                AlertDialog.Builder poiBuilder = new AlertDialog.Builder(GPSActivity.this);
...
//        isInverse = false;
    ...
    private void setSetting() {
        mPsettingDialog = new VoucherSettingDialog(GPSActivity.this, new OnClickListener() {
            public void onClick(View v) {
                WataLog.i("check 0");
                SettingDialog sensitive = new SettingDialog();
                AlertDialog senseDialog = sensitive.makeSensitiveSettingDilog(GPSActivity.this);
                senseDialog.show();
            }
        });
                ...
                if (_wifiScanner == null) {
                    ...
                    try {
                        ...
                        if (Build.VERSION.SDK_INT >= 18 && !wifiManager.isScanAlwaysAvailable()) {
                            ((Activity) GPSActivity.this).startActivityForResult(
