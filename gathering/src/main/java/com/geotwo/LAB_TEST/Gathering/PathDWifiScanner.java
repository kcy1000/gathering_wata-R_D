...
public class PathDWifiScanner {
     ...
     */
    public PathDWifiScanner(Context appContext, WifiManager manager, Handler handler, List<ScanResult> list, BLEManager bleManager) {
...
//            _SCAN_RESULT_THIS_EPOCH.B9_ColStartP_CVADDR("kcy1000");
        ...
        _SCAN_RESULT_THIS_EPOCH.B5_ColStartP_X = ((PathDrawingActivity._startPoint.x - PathDrawingActivity.basePointX) * 10);
        _SCAN_RESULT_THIS_EPOCH.B6_ColStartP_Y = ((PathDrawingActivity._startPoint.y - PathDrawingActivity.basePointY) * 10);

        _SCAN_RESULT_THIS_EPOCH.B12_ColEndP_X = ((PathDrawingActivity._endPoint.x - PathDrawingActivity.basePointX) * 10);
        _SCAN_RESULT_THIS_EPOCH.B13_ColEndP_Y = ((PathDrawingActivity._endPoint.y - PathDrawingActivity.basePointY) * 10);

        _SCAN_RESULT_THIS_EPOCH.B14_ColLinkID = PathDrawingActivity.mCurrentPath;
        WataLog.d("_SCAN_RESULT_THIS_EPOCH.B14_ColLinkID=" + _SCAN_RESULT_THIS_EPOCH.B14_ColLinkID);
        ...
        if (!PathDrawingActivity.isInverse) {
...
//			_SCAN_RESULT_THIS_EPOCH.B13_ColEndP_Y = sy;
        ...
        // 방향정보
        _SCAN_RESULT_THIS_EPOCH.B16_ColLinkHeading = (float) PathDrawingActivity.lineHeader;
...
//		Vector tempGRS80 = toGRS80.transformTM2GP(GatheringMyWayActivity._startPoint.y, GatheringMyWayActivity._startPoint.x);
        ...
        // 좌표변환은 수행
        Proj4 proj4 = new Proj4(PathDrawingActivity._startPoint.x, PathDrawingActivity._startPoint.y, CRSRegistry.EPSG_5186, CRSRegistry.EPSG_4326);
...
//                        WataLog.i("CCCCCCCCCCCCCCCCCCCCCCCCC");
                            initialmm.MM_initialize3(PathDrawingActivity.lineSelected);
                        }
                    ...
                    WataLog.d("_dataCore.getGatheringOption()=" + _dataCore.getGatheringOption());
                        ...
                        if (epoch_scanData.FD2_ColP_X == 0 || epoch_scanData.FD2_ColP_X == 0.0) {
                            epoch_scanData.FD2_ColP_X = PathDrawingActivity._startPoint.x;
                        WataLog.d("GatheringMyWayActivity._startPoint.x =" + PathDrawingActivity._startPoint.x);
                        }
                        if (epoch_scanData.FD3_ColP_Y == 0 || epoch_scanData.FD3_ColP_Y == 0.0) {
                            epoch_scanData.FD3_ColP_Y = PathDrawingActivity._startPoint.y;
                        WataLog.d("GatheringMyWayActivity._startPoint.y =" + PathDrawingActivity._startPoint.y);
                        }
                    ...
                    WataLog.d("xxxxx=" + epoch_scanData.FD2_ColP_X + "/yyyyy=" + epoch_scanData.FD3_ColP_Y);
                        ...
                        if (_UIHandler != null) {
                            ...
                            if (epoch_scanData.FD2_ColP_X != 0)
                                ...
                                colP[0] = PathDrawingActivity._startPoint.x;
                            if (epoch_scanData.FD3_ColP_Y != 0)
                                colP[1] = epoch_scanData.FD3_ColP_Y;
                            else
                                colP[1] = PathDrawingActivity._startPoint.y;
                            msg.obj = colP;
...
//						epoch_scanData.FD17_TM_Y = epoch_scanData.FD3_ColP_Y;
                        ...
                        epoch_scanData.FD2_ColP_X = (epoch_scanData.FD2_ColP_X - PathDrawingActivity.basePointX) * 10;
                        epoch_scanData.FD3_ColP_Y = (epoch_scanData.FD3_ColP_Y - PathDrawingActivity.basePointY) * 10;
