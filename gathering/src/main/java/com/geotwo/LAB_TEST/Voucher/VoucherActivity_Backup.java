...
public class VoucherActivity_Backup extends AppCompatActivity implements OnClickListener {
    static {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (intent != null) {
            ...
            //         기존     http://13.209.43.191:3000/subwayGuideLines?&areano=0&lineno=2호선&stationnm=강남역&floor=B1
//         수정     http://13.209.43.191:3000/subwayGuideLines?&areaNo=0&lineNo=2&stationNo=2&floor=B1
            ...
            WataLog.d("gid=" + gid);
            WataLog.d("gid=" + gid.length());
            WataLog.d("s_id=" + Sid);
            WataLog.d("num_line=" + mNumLine);
            WataLog.d("sub_name=" + mSubName);
            WataLog.d("floors_lever=" + mFloorsLever);
...
//            mRelativeY = 4495570;
            ...
            WataLog.d("centerX=" + centerX);
            WataLog.d("centerY=" + centerY);
            WataLog.d("lineName=" + lineName);
...
//                setWebView("drawPosition", String.valueOf(END_POINT_X) + "|" + String.valueOf(END_POINT_Y));
        ...
        if (!_bleManager.isBluetoothEnabled()) {
            geo2.lbsp.ible.Utils.startBluetooth(this, new StartCompletedListener() {
                public void onStartCompleted() {
                    Toast.makeText(VoucherActivity_Backup.this, "'Bluetooth가 활성화 되었습니다.", Toast.LENGTH_SHORT).show();
                }
            });
        }
    ...
    private void webViewSetting() {
        ...
        mVoucherWebBridge = new VoucherActivity_Backup.VoucherWebBridge(VoucherActivity_Backup.this);
        ...
        mWebView.setWebViewClient(new VoucherActivity_Backup.WebViewClientClass());
...
//        public double endPointY = 0.0;
        ...
        private VoucherActivity_Backup mVoucherActivity;

        public VoucherWebBridge(VoucherActivity_Backup voucherActivity) {
...
//        onToast(Gravity.CENTER, String.valueOf(overLine));
    ...
    private void setDeletePOIPopup(final PoiInfo items, final int position) {
        AlertDialog.Builder alBuilder = new AlertDialog.Builder(VoucherActivity_Backup.this);
                ...
                for (int a = 0; a <= list.length - 1; a++) {
                    ...
                    if (fileName.length > 1) {
                        if (fileName[1].equals("log")) {
                            ...
                            String[] rFileName = rFile[2].split("_");

                            WataLog.d("rFileName[0]=" + rFileName[0]);
                            WataLog.d("rFileName[0]=" + rFileName[1]);

                            int sPosition = Integer.valueOf(rFileName[0]) - 1;
                            WataLog.d("sPosition=" + sPosition);

                            if ("F".equals(rFileName[1])) {
                                mSubwayInfo.get(sPosition).setCompletionF("완료");
                            } else {
                                mSubwayInfo.get(sPosition).setCompletionR("완료");
                            }

                            if (mSubwayInfo.get(sPosition).getCompletionF().equals("완료")) {
                                if (mSubwayInfo.get(sPosition).getCompletionR().equals("완료")) {
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.poi_file_upload_btn:
                ...
                AlertDialog.Builder poiBuilder = new AlertDialog.Builder(VoucherActivity_Backup.this);
...
//                    mStepLength = 0;
    ...
    private void onRecordOn() {
        ...
        // 파일이름생성
        final String autoName = StaticManager.title + "-" + StaticManager.floorName + "-" + lineNum;
...
//            }
            mSubwayInfo.get(NOW_POSITION).setCompletionF("완료");
            mRecordAdapter.notifyDataSetChanged();
            ...
            mSubwayInfo.get(NOW_POSITION).setCompletionR("완료");
            mRecordAdapter.notifyDataSetChanged();
...
//        isInverse = false;
    ...
    private void setSetting() {
        mPsettingDialog = new VoucherSettingDialog(VoucherActivity_Backup.this, new OnClickListener() {
            public void onClick(View v) {
                WataLog.i("check 0");
                SettingDialog sensitive = new SettingDialog();
                AlertDialog senseDialog = sensitive.makeSensitiveSettingDilog(VoucherActivity_Backup.this);
                senseDialog.show();
            }
        });
                ...
                if (_wifiScanner == null) {
                    ...
                    try {
                        ...
                        if (Build.VERSION.SDK_INT >= 18 && !wifiManager.isScanAlwaysAvailable()) {
                            ((Activity) VoucherActivity_Backup.this).startActivityForResult(
...
//    http://13.209.43.191:3000/subwayGuideLines2
    ...
    private void getSubwayInfo(String areano, String lineno, String stationnm, String floor) {
        ...
        //            http://13.209.43.191:3000/subwayGuideLines?&areaNo=0&lineNo=2&stationnm=강남역&floor=B1
        ...
        new AsyncTask<Void, Void, JSONObject>() {
            ...
            protected JSONObject doInBackground(Void... voids) {
                ...
                try {
                    ...
                    URL url = new URL("http://15.164.236.24:8081/api/collect/upload/" + UUID);
                    WataLog.d("url=" + url);
...
//    }
    ...
    private void setUpload() {
        ...
        setProgress(true);
        Retrofit retrofit = new Retrofit.Builder()
                .baseUrl("http://15.164.236.24:8081")
                .addConverterFactory(GsonConverterFactory.create())
                .build();
        RetrofitExService retrofitExService = retrofit.create(RetrofitExService.class);
        ...
        new AsyncTask<Void, Void, JSONObject>() {
            ...
            protected JSONObject doInBackground(Void... voids) {
                ...
                try {
                    ...
                    URL url = new URL("http://15.164.236.24:8081/api/collect/poi/" + StaticManager.gid);
                    WataLog.d("url=" + url);
